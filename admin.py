...
def showroster(df):
    ...
    col2.link_button(label='Voting Members', url=f"mailto:?to=jschlick@hntb.com;moisesramos@ieee.org;heather.riebeling@aecom.com;brett.tharp@stvinc.com;eric.parsons@southwire.com;allen.jennifer@ieee.org&bcc={email_votingmembers}&subject=IEEE VT/OCS Standards Committee: ")
    col3.link_button(label='Active Members', url=f"mailto:?to=jschlick@hntb.com;moisesramos@ieee.org;heather.riebeling@aecom.com;brett.tharp@stvinc.com;eric.parsons@southwire.com;allen.jennifer@ieee.org&bcc={email_activemembers}&subject=IEEE VT/OCS Standards Committee: ")
    if col4.button('All Members'):
        st.warning('There are too many addressess to create an email automatically. Copy the list below.')
        st.link_button(label='Blank Email', url=f"mailto:?to=jschlick@hntb.com;moisesramos@ieee.org;heather.riebeling@aecom.com;brett.tharp@stvinc.com;eric.parsons@southwire.com;allen.jennifer@ieee.org&subject=IEEE VT/OCS Standards Committee: ")
